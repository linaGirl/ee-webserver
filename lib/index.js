	...
	module.exports = new Class( {
		...
		, init: function( options ){
			...
			if ( this.config.http ) this.http 	= new HTTPServer( { config: this.config.http, base: module.exports } );
			if ( this.config.https ) this.https = new HTTPSServer( { config: this.config.https, base: module.exports } );
		}

	...
	module.exports = new Class( {
		...
		, read: function(){
			return this.request.read.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, setEncoding: function(){
			return this.request.setEncoding.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, resume: function(){
			return this.request.resume.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, pause: function(){
			return this.request.pause.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, pipe: function(){
			return this.request.pipe.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, unpipe: function(){
			return this.request.unpipe.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, unshift: function(){
			return this.request.unshift.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}
		, wrap: function(){
			return this.request.wrap.apply( this.request, Array.prototype.slice.call( arguments, 0 ) );
		}

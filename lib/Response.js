	...
	module.exports = new Class( {
		...
		, write: function(){
			return this.response.write.apply( this.response, Array.prototype.slice.call( arguments, 0 ) );
		}
		, end: function(){
			return this.response.end.apply( this.response, Array.prototype.slice.call( arguments, 0 ) );
		}
